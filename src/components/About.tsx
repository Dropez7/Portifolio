            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-12 items-center px-6">
                ...
                <div>
                    <h1 className="text-4xl md:text-5xl enfasegradientpurple">
                        Desenvolver software não é só sobre código, é sobre
                        criar oportunidades e concretizar sonhos.
                    </h1>
                    <p className="mt-4 text-base md:text-lg text-gray-700">
                        Sou desenvolvedor full-stack, apaixonado por tecnologia
                        e inovação. Com uma base sólida em Ciência da Computação
                        e experiência prática em tecnologias modernas
                        (JavaScript, TypeScript, React, Next.js, entre outras),
                        crio experiências digitais que conectam pessoas e
                        ideias.
                    </p>
                    <p className="mt-4 text-base md:text-lg text-gray-700">
                        Acredito que a tecnologia deve servir como ponte entre
                        ideias e soluções reais. Meu objetivo é criar softwares
                        que simplificam processos, conectam pessoas e tornam o
