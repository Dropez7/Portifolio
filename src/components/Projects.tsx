                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-[#13132A] rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105">
                            ...
                            <p className="text-gray-300 mt-2 px-8">
                                Sistema para otimização do uso do laboratório de
                                informática da UFRRJ, permitindo que os alunos
                                agendem computadores com antecedência e
                                visualizem a disponibilidade em tempo real.
                            </p>
                        ...
                        <div className="bg-[#13132A] rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105">
                            ...
                            <p className="text-gray-300 mt-2">
                                Projeto desenvolvido em React para consumir APIs
                                RESTfull criada por mim de forma simples e
                                eficiente. A aplicação permite a interação com
                        ...
                        <div className="bg-[#13132A] rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105">
                            ...
                            <p className="text-gray-300 mt-2 px-8">
                                API RESTfull simples construída com Node.js e
                                Express. Ela oferece uma implementação básica de
                                métodos como GET, POST, PUT e DELETE para
