            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-12 items-center px-6">
                ...
                <div className="text-right">
                    ...
                    <p className="mt-4 text-base md:text-lg text-gray-700">
                        Como desenvolvedor full-stack, trabalho com tecnologias
                        modernas para criar aplicações eficientes e escaláveis.
                        No front-end, utilizo{" "}
                        <span className="enfasegradientcian">React</span> e{" "}
                        <span className="enfasegradientcian">Tailwind CSS</span>
                        , enquanto no back-end desenvolvo APIs robustas com{" "}
                        <span className="enfasegradientcian">Node.js</span> e
                        banco de dados{" "}
